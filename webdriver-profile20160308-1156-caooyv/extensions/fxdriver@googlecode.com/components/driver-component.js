...
goog.string.compareVersions = function(a, b) {
  for (var c = 0, d = goog.string.trim(String(a)).split("."), e = goog.string.trim(String(b)).split("."), f = Math.max(d.length, e.length), g = 0;0 == c && g < f;g++) {
    var h = d[g] || "", l = e[g] || "", q = /(\d*)(\D*)/g, p = /(\d*)(\D*)/g;
    do {
      var k = q.exec(h) || ["", "", ""], r = p.exec(l) || ["", "", ""];
  ...
  try {
    ...
    if (!goog.userAgent.IE || goog.userAgent.isDocumentModeOrHigher(9)) {
      for (var f = {}, g = d.getElementsByTagName("*"), h = 0;h < g.length;++h) {
        ...
        if (!f[q]) {
          var p = l.lookupPrefix(q);
          if (!p) {
            var k = q.match(".*/(\\w+)/?$"), p = k ? k[1] : "xhtml"
          }
          f[q] = p;
        }
      }
...
bot.dom.getOverflowState = function(a, b) {
  ...
  for (var f = bot.dom.getClientRegion(a, b), g = goog.dom.getOwnerDocument(a), h = g.documentElement, l = g.body, q = bot.dom.getEffectiveStyle(h, "overflow"), p, k = c(a);k;k = c(k)) {
    var r = d(k);
    if ("visible" != r.x || "visible" != r.y) {
      ...
      if (m && "visible" != r.x || n && "visible" != r.y) {
        if (p && (r = e(k), f.left >= h.scrollWidth - r.x || f.right >= h.scrollHeight - r.y)) {
          return bot.dom.OverflowState.HIDDEN;
        }
        f = bot.dom.getOverflowState(k);
        return f == bot.dom.OverflowState.HIDDEN ? bot.dom.OverflowState.HIDDEN : bot.dom.OverflowState.SCROLL;
...
bot.dom.getClientRect = function(a) {
  function b(a) {
    ...
    if (c) {
      var d = parseFloat(c[1]), e = parseFloat(c[2]), p = parseFloat(c[3]), k = parseFloat(c[4]), r = parseFloat(c[5]), c = parseFloat(c[6]), n = f.left + f.width, m = f.top + f.height, t = f.left * d, d = n * d, u = f.left * e, e = n * e, v = f.top * p, p = m * p, w = f.top * k, n = m * k, m = t + v + r, k = u + w + c, v = d + v + r, w = e + w + c, t = t + p + r, u = u + n + c, r = d + p + r, c = e + n + c;
...
fxdriver.error.toJSON = function(a) {
  ...
  if (a.stack) {
    for (var d = a.stack.replace(/\s*$/, "").split("\n"), e = d.shift();e;e = d.shift()) {
      ...
      h = e.match(/^([a-zA-Z_$][\w./<$]*)?(?:\(.*\))?@(.+)?$/);
      b.push({methodName:h[1], fileName:h[2], lineNumber:f, columnNumber:g});
    }
  }
    ...
    for (var q = c.toUpperCase(), p = 0;p < c.length;p++) {
      ...
      if ("\ue000" == k) {
        ...
        if (r) {
          ...
          t = Utils.keyEvent(a, b, "keydown", m, 0, e, r || h, l, d, !1);
          Utils.keyEvent(a, b, "keypress", k, n, e, r || h, l, d, !t);
...
Dispatcher.prototype.init_ = function() {
  ...
  this.bind_("/session/:sessionId/element/:id/location").on(fxdriver.Request.Method.GET, Dispatcher.executeAs("getElementLocation"));
  ...
  this.bind_("/session/:sessionId/element/:id/size").on(fxdriver.Request.Method.GET, Dispatcher.executeAs("getElementSize"));
...
bot.events.TouchEventFactory_.prototype.create = function(a, b) {
  ...
  var f = goog.dom.getOwnerDocument(a), g = goog.dom.getWindow(f), h = e(b.changedTouches), l = b.touches == b.changedTouches ? h : e(b.touches), q = b.targetTouches == b.changedTouches ? h : e(b.targetTouches), p;
  bot.events.BROKEN_TOUCH_API_ ? (p = f.createEvent("MouseEvents"), p.initMouseEvent(this.type_, this.bubbles_, this.cancelable_, g, 1, 0, 0, b.clientX, b.clientY, b.ctrlKey, b.altKey, b.shiftKey, b.metaKey, 0, b.relatedTarget), p.touches = l, p.targetTouches = q, p.changedTouches = h, p.scale = b.scale, p.rotation = b.rotation) : (p = f.createEvent("TouchEvent"), goog.userAgent.product.ANDROID ? p.initTouchEvent(l, q, h, this.type_, g, 0, 0, b.clientX, b.clientY, b.ctrlKey, b.altKey, b.shiftKey, 
  b.metaKey) : p.initTouchEvent(this.type_, this.bubbles_, this.cancelable_, g, 1, 0, 0, b.clientX, b.clientY, b.ctrlKey, b.altKey, b.shiftKey, b.metaKey, l, q, h, b.scale, b.rotation), p.relatedTarget = b.relatedTarget);
  return p;
};
...
var FirefoxDriver = function(a, b, c, d) {
  ...
  this.window = c;
  this.pageLoadingStrategy = d || "normal";
    ...
    if (goog.isString(b.id)) {
      ...
      if (goog.isNumber(b.id)) {
        ...
        if (goog.isObject(b.id) && "ELEMENT" in b.id) {
          goog.log.info(FirefoxDriver.LOG_, "Switching to frame by element: " + b.id.ELEMENT);
...
FirefoxDriver.prototype.mouseMoveTo = function(a, b) {
  ...
  if (this.enableNativeEvents) {
    a: {
      ...
      var g;
      try {
        var d = f, h = a.session.getTopWindow(), l = bot.window.getScroll(h), q = goog.math.Coordinate.sum(l, d);
        ...
        if (k.code == bot.ErrorCode.MOVE_TARGET_OUT_OF_BOUNDS) {
          a.sendError(new WebDriverError(bot.ErrorCode.MOVE_TARGET_OUT_OF_BOUNDS, "Given coordinates (" + f.x + ", " + f.y + ") are outside the document. Error: " + k));
          break a;
        }
        throw k;
      }
      var q = (d = a.session.isMousePressed()) ? f : g, l = Utils.getBrowserSpecificOffset(a.session.getBrowser()), h = q.x + l.x, q = q.y + l.y, p = Utils.getNativeMouse(), r = Utils.getNodeForNativeEvents(e);
      if (p && r) {
        var n = a.session.getMousePosition(), m = n.x + l.x, l = n.y + l.y;
        goog.log.info(FirefoxDriver.LOG_, "Moving from (" + n.x + ", " + n.y + ") to (" + g.x + ", " + g.y + ")");
        p.mouseMove(r, m, l, h, q);
...
bot.action.drag = function(a, b, c, d, e, f) {
  ...
  for (var h = 1;h <= d;h++) {
    var l = Math.floor(h * b / d), q = Math.floor(h * c / d), p = bot.dom.getClientRect(a), l = new goog.math.Coordinate(e.x + g.left + l - p.left, e.y + g.top + q - p.top);
    f.move(a, l);
  }
  f.releaseButton();
};
...
WebElement.clickElement = function(a, b) {
  ...
  p = Utils.getLocation(d, "A" == d.tagName), g = p.width ? Math.floor(p.width / 2) : 0, k = p.height ? Math.floor(p.height / 2) : 0;
  if (!q && this.enableNativeEvents && e && f && h && l) {
    goog.log.info(WebElement.LOG_, "Using native events for click");
    p = Utils.scrollIntoView(d, 0 == a.session.elementScrollBehavior, new goog.math.Coordinate(g, k));
...
WebElement.sendKeysToElement = function(a, b) {
  ...
  this.jsTimer.setTimeout(function() {
    ...
    try {
      Utils.type(a.session.getDocument(), h, b.value.join(""), l.enableNativeEvents, l.jsTimer, !0), a.send();
    } catch (f) {
      a.sendError(f);
    }
  }, 0);
...
WebElement.getElementLocation = function(a, b) {
  ...
  a.value = {x:Math.round(c.x + d.pageXOffset), y:Math.round(c.y + d.pageYOffset)};
  a.send();
};
